...
*   **Тестирование API:** Postman (написание запросов GET/POST)
...
*   **Figma:** Навык тестирования UI/UX на соответствие макетам, измерение отступов, проверка типографики и состояний элементов
